...
const releaseBranchesSchema = Joi.array().items(releaseBranchRule)
...
const schema = (context) => {
  ...
  return Joi.object()
    .keys({
      ...
      'release-branches': Joi.array()
        .items(releaseBranchRule)
        .default(DEFAULT_CONFIG['release-branches']),
...
exports.releaseBranchesSchema = releaseBranchesSchema
