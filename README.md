...
- **Kebab-Case Outputs** - All action outputs use kebab-case (e.g., `resolved-version`, `tag-name`) instead of snake_case, for consistency with GitHub Actions input conventions.
